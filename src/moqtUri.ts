 ...
 * MOQT URI スキーム処理
 *
 * draft-ietf-moq-transport-20 §3.1.1 (MOQT URI Scheme)
 * draft-ietf-moq-transport-20 §3.1.2 (Fragment Identifiers)
 * draft-ietf-moq-transport-20 §3.1.4 (WebTransport)
 */
...
/**
 * fragment type identifier の許容文字 (draft-ietf-moq-transport-20 §3.1.2):
 *
 ...
 *
 * draft-ietf-moq-transport-20 §3.1.4:
 *
 ...
 *
 * fragment は WebTransport に渡さない (draft-ietf-moq-transport-20 §3.1.2):
 *
