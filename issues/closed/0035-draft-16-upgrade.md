...
draft-16 対応は完了済み。未完成だった SUBSCRIBE_NAMESPACE の完全実装と Subgroup 再オープン禁止を除き、全項目が対応された。draft-17 対応 (feature/moq-transport-17 ブランチ) に移行したため、この issue を close する。
