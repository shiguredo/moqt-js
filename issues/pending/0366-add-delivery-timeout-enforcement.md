...
- OBJECT_DELIVERY_TIMEOUT / SUBGROUP_DELIVERY_TIMEOUT（両方非ゼロなら小さい方）超過時にデータグラムが破棄される。送信前の経過時間チェックと超過判定は純粋関数として実装され、単体テストで検証されていること。
